...
int main(){
	float /*hacer,*/ area, seguro, volumen, area_t, base, altura, pi=3.1416, radio, inclinacion; 
	...
	}while((int(hacer)>=65)||(int(hacer)<=122)||(int(hacer)<91)||(int(hacer)>96)||(int(hacer)<49)||(int(hacer)>50));
